...
/**
 * This class defines elisfields subplugininfo
 */
class elisfields extends \core\plugininfo\base {
    ...
    public $typerootdir = '/local/eliscore/fields/';
    /** @var string the plugin name, eg. assignment, ldap */
    public $name = 'elisfields';
    /** @var string the localized plugin name */
    public $displayname = 'ELIS Custom Fields';
