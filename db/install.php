...
function xmldb_local_eliscore_install() {
    ...
    static $tablemap = array(
        'elis_scheduled_tasks'         => 'local_eliscore_sched_tasks',
        'elis_workflow_instances'      => 'local_eliscore_wkflow_inst',
        'elis_field'                   => 'local_eliscore_field',
        'elis_field_categories'        => 'local_eliscore_field_cats',
        'elis_field_contextlevels'     => 'local_eliscore_field_clevels',
        'elis_field_category_contexts' => 'local_eliscore_fld_cat_ctx',
        'elis_field_data_text'         => 'local_eliscore_fld_data_text',
        'elis_field_data_int'          => 'local_eliscore_fld_data_int',
        'elis_field_data_num'          => 'local_eliscore_fld_data_num',
        'elis_field_data_char'         => 'local_eliscore_fld_data_char',
        'elis_field_owner'             => 'local_eliscore_field_owner'
    );
    ...
    if ($oldversion !== false) {
        ...
        set_config('version', 2015010400, 'local_eliscore');
        xmldb_local_eliscore_upgrade(2015010400);
    }
